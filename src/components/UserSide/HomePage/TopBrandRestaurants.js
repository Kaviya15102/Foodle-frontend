...
//   useEffect(() => {
//     axios
//       .get("http://localhost:8090/restaurant/all")
//       .then((response) => {
...
//       axios
//         .post("http://localhost:8090/order", order)
//         .then((response) => {
//           console.log(response.data);
//           setCart([]);
...
//             )}
//             <div >
//               <h3 style={{ color: 'white',fontWeight: 'bold', fontSize: '15px'  }}>{restaurant.restaurantName}</h3>
